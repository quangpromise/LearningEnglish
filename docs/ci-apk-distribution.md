...
1. Build APK release: **1 file duy nhất**, bản **universal** (gộp 2 kiến trúc ARM: `arm64-v8a` + `armeabi-v7a`, đã bật R8 minify + shrink resources). Không còn phát hành riêng các bản `--split-per-abi` (arm64/armeabi/x86_64) nữa — đơn giản hoá theo yêu cầu 2026-09-04, tránh người tải nhầm file sai kiến trúc khi sideload.
...
Vào thẳng trang **[Releases](https://github.com/quangpromise/LearningEnglish/releases/tag/latest)** để xem file + thời điểm build gần nhất.
