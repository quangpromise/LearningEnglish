...
const kSongs = [
  Song(
    ...
    lyrics: [
      ...
      LyricLine(54.2, 'And shake away the heat', 'Rồi rũ bỏ hơi ấm đi'),
      LyricLine(
        58.3,
      ...
      LyricLine(74, 'Let down, and so spent', 'Thất vọng, và kiệt sức'),
      LyricLine(
        78.5,
      ...
      LyricLine(115.8, 'And shake away the heat', 'Rồi rũ bỏ hơi ấm đi'),
      LyricLine(
        119.8,
        'Tell the truth or live a lie',
        'Nói thật, hay sống trong dối trá',
      ...
      LyricLine(152.8, "And you're breaking", 'Và bạn đang vỡ vụn'),
      LyricLine(
        153.6,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(190, 'His aim is never true', 'Anh ta chưa bao giờ thật lòng'),
      LyricLine(
        194.5,
      ...
      LyricLine(209.5, 'Exhausted and resigned', 'Kiệt sức và cam chịu'),
      LyricLine(
        210.5,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(51.5, "I've either gotta turn around", 'Tôi phải quay đầu lại'),
      LyricLine(55.6, 'Or learn how to swim', 'Hoặc học cách tự bơi'),
      LyricLine(
        61,
        "We're in the same boat",
        'Chúng ta cùng chung một con thuyền',
      ...
      LyricLine(70.1, 'Should I take a break', 'Tôi nên dừng lại nghỉ ngơi'),
      LyricLine(
        74.4,
      ...
      LyricLine(93.3, "I've either gotta turn around", 'Tôi phải quay đầu lại'),
      ...
      LyricLine(179.4, 'Or learn how to swim', 'Hoặc học cách tự bơi'),
    ],
  ),
  Song(
    ...
    lyrics: [
      LyricLine(11.9, 'I saved the world', 'Tôi đã cứu cả thế giới'),
      LyricLine(14.9, 'And made it mine', 'Và biến nó thành của riêng tôi'),
      LyricLine(
        17.2,
      ...
      LyricLine(56, 'Will soon dissolve', 'Rồi sẽ sớm tan biến'),
      LyricLine(
        58,
        'They\'ll build a statue that\'s a mile tall',
        'Họ sẽ dựng nên một bức tượng cao cả dặm',
      ),
      LyricLine(63.5, 'The future kings', 'Những vị vua tương lai'),
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(38.4, 'We polished all the chrome', 'Ta đánh bóng cả lớp crôm'),
      LyricLine(
        40.8,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(85.5, 'You know that', 'Em biết đấy'),
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(91.6, 'But now it\'s too late', 'Nhưng giờ đã quá muộn'),
      LyricLine(
        95.5,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(147.6, 'And I ask you to stay', 'Và tôi lại xin em ở lại'),
    ],
  ),
  Song(
    title: 'Saboteurs',
    ...
    lyrics: [
      ...
      LyricLine(210.9, 'Run like the wind', 'Chạy như gió cuốn'),
      LyricLine(
        215.4,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(63.7, 'She dreams in blue', 'Nàng mơ trong sắc xanh'),
      LyricLine(
        82.5,
        'Wait for it, it\'s all she ever knew',
        'Hãy chờ đợi, đó là tất cả những gì nàng từng biết',
      ...
      LyricLine(151.7, 'She dreams in blue', 'Nàng mơ trong sắc xanh'),
      LyricLine(
        170.2,
        'Wait for it, it\'s all she ever knew',
        'Hãy chờ đợi, đó là tất cả những gì nàng từng biết',
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(64.9, 'And I wait, yeah I wait', 'Và tôi chờ, vâng tôi chờ'),
      LyricLine(71.1, 'Hey hey, I\'m ok', 'Này này, tôi ổn mà'),
      LyricLine(
        75.2,
        'I don\'t need this anyway, I\'m fine',
        'Dù sao tôi cũng không cần điều này, tôi ổn',
      ),
      LyricLine(78.7, 'What\'s yours and mine', 'Cái gì là của em và của tôi'),
      LyricLine(81.6, 'Oh oh, I don\'t know', 'Ồ, tôi chẳng biết'),
      LyricLine(
        86.4,
      ...
      LyricLine(135.4, 'And I wait, yeah I wait', 'Và tôi chờ, vâng tôi chờ'),
      LyricLine(142, 'Hey hey, I\'m ok', 'Này này, tôi ổn mà'),
      LyricLine(
        145.7,
        'I don\'t need this anyway, I\'m fine',
        'Dù sao tôi cũng không cần điều này, tôi ổn',
      ),
      LyricLine(150.1, 'What\'s yours and mine', 'Cái gì là của em và của tôi'),
      LyricLine(151.9, 'Oh oh, I don\'t know', 'Ồ, tôi chẳng biết'),
      LyricLine(
        157,
        'What I was ever hoping I would find',
        'Điều tôi từng hy vọng mình sẽ tìm thấy là gì',
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(112.3, 'The gravity holds me down', 'Trọng lực cứ giữ tôi lại'),
      LyricLine(
        118,
