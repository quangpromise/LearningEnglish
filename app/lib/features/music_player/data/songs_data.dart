...
const kSongs = [
  Song(
    ...
    lyrics: [
      ...
      LyricLine(61.5, 'And shake away the heat', 'Rồi rũ bỏ hơi ấm đi'),
      LyricLine(
        62.3,
        'Tell the truth or live a lie',
        'Nói thật, hay sống trong dối trá',
      ),
      LyricLine(63, "Just don't close your eyes", 'Chỉ xin đừng nhắm mắt lại'),
      LyricLine(74.5, 'Let down, and so spent', 'Thất vọng, và kiệt sức'),
      LyricLine(
        78.6,
      ...
      LyricLine(122.6, 'And shake away the heat', 'Rồi rũ bỏ hơi ấm đi'),
      LyricLine(
        123.1,
        'Tell the truth or live a lie',
        'Nói thật, hay sống trong dối trá',
      ...
      LyricLine(124.5, "And you're breaking", 'Và bạn đang vỡ vụn'),
      LyricLine(
        124.6,
      ...
      LyricLine(124.8, 'Always standing strong', 'Luôn tỏ ra mạnh mẽ'),
      LyricLine(124.9, "But you don't need", 'Nhưng bạn đâu cần phải'),
      LyricLine(
        125,
        "To act like you don't bleed",
        'Giả vờ như mình không hề đau',
      ),
      LyricLine(125.1, 'When you come falling down', 'Khi bạn đang gục ngã'),
      LyricLine(
        126,
        "Cuz there is no healing when you're not feeling",
        'Vì sẽ chẳng thể chữa lành nếu bạn không cho phép mình cảm nhận',
      ),
      LyricLine(127, 'Anything at all', 'Bất cứ điều gì'),
    ],
  ),
  Song(
    title: 'Circles',
    ...
    lyrics: [
      ...
      LyricLine(82.2, 'No, no, ohh', 'Không, không, ồ'),
      LyricLine(
        86,
      ...
      LyricLine(105.5, 'Exhausted and resigned', 'Kiệt sức và cam chịu'),
      LyricLine(
        112.2,
      ...
      LyricLine(128.3, 'No, no, ohh', 'Không, không, ồ'),
    ],
  ),
  Song(
    title: 'Same Boat',
    ...
    lyrics: [
      ...
      LyricLine(30.1, 'Facing each other', 'Đối diện nhau'),
      LyricLine(
        34.2,
      ...
      LyricLine(51.7, "I've either gotta turn around", 'Tôi phải quay đầu lại'),
      ...
      LyricLine(71.5, 'Should I take a break', 'Tôi nên dừng lại nghỉ ngơi'),
      LyricLine(75, 'Or throw myself overboard?', 'Hay nhảy hẳn khỏi thuyền?'),
      LyricLine(
        83,
      ...
      LyricLine(93.5, "I've either gotta turn around", 'Tôi phải quay đầu lại'),
      ...
      LyricLine(154, "I've chosen my path", 'Tôi đã chọn con đường của mình'),
      LyricLine(
        158.1,
      ...
      LyricLine(175.8, "I'm either gonna fade away", 'Tôi sẽ dần biến mất'),
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(21.4, 'Look on my works', 'Hãy nhìn vào những gì tôi làm nên'),
      LyricLine(24.6, 'They\'re pretty sweet', 'Chúng thật tuyệt vời'),
      LyricLine(
        27.8,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(44.6, 'We polished all the chrome', 'Ta đánh bóng cả lớp crôm'),
      LyricLine(
        48.4,
      ...
      LyricLine(92.9, 'So free, so right', 'Thật tự do, thật đúng đắn'),
      LyricLine(95.1, 'Remember when', 'Còn nhớ không'),
      LyricLine(
        97.2,
      ...
      LyricLine(105.5, 'Flowing so free', 'Trôi thật tự do'),
      LyricLine(109.7, 'Blowing in the breeze', 'Lay động trong làn gió'),
      LyricLine(
        112.9,
      ...
      LyricLine(119.5, 'But there along the way', 'Nhưng rồi trên đường đi'),
      LyricLine(
        121.7,
      ...
      LyricLine(201.5, 'Remember when', 'Còn nhớ không'),
      LyricLine(
        204.3,
      ...
      LyricLine(210.5, 'Remember when', 'Còn nhớ không'),
      LyricLine(
        211.5,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(51, 'And I\'m stuck to you', 'Và tôi đã dính chặt lấy em'),
      LyricLine(
        54.1,
      ...
      LyricLine(91.3, 'Hold onto me', 'Hãy giữ chặt lấy tôi'),
      LyricLine(
        92.3,
        'And hand in hand we\'ll follow',
        'Và tay trong tay ta sẽ cùng bước',
      ),
      LyricLine(93.5, 'Hold onto me', 'Hãy giữ chặt lấy tôi'),
      LyricLine(
        94.8,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(59.1, 'But I\'m letting go', 'Nhưng tôi đang buông bỏ'),
      LyricLine(62.9, 'I\'m letting go', 'Tôi đang buông bỏ'),
      LyricLine(
        65.8,
        'It\'s a history that never really grows',
        'Đó là một quá khứ chẳng bao giờ lớn thêm được nữa',
      ),
      LyricLine(72.5, 'I\'m letting go', 'Tôi đang buông bỏ'),
      LyricLine(75.3, 'I\'m letting go', 'Tôi đang buông bỏ'),
      LyricLine(
        78.4,
        'It\'s a silent wind that never really blows',
        'Đó là cơn gió lặng thinh chẳng bao giờ thực sự thổi',
      ),
      LyricLine(85.1, 'I\'m letting go', 'Tôi đang buông bỏ'),
      LyricLine(
        96.1,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(98.6, 'But now it\'s too late', 'Nhưng giờ đã quá muộn'),
      LyricLine(
        103.4,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(36, 'The she, was destined to be', 'Rằng nàng, định sẵn sẽ là'),
      LyricLine(
        40.5,
        'My favorite regret',
        'Nỗi hối tiếc yêu thích nhất của tôi',
      ),
      LyricLine(47.5, 'And all through the years', 'Và suốt bao năm tháng'),
      LyricLine(51.1, 'The joy and the tears', 'Niềm vui và nước mắt'),
      LyricLine(
        53.2,
      ...
      LyricLine(97.1, 'He\'s gentle and kind', 'Anh ấy dịu dàng và tốt bụng'),
      LyricLine(100.3, 'And totally blind', 'Nhưng hoàn toàn không nhận ra'),
      LyricLine(
        103,
      ...
      LyricLine(190.1, 'And wake you up at last', 'Và đánh thức nàng lần cuối'),
      LyricLine(
        227.8,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(99.5, 'So please just escape', 'Vậy nên xin hãy trốn thoát đi'),
      LyricLine(
        100.1,
        'Before my resolve goes away',
        'Trước khi quyết tâm của tôi lung lay',
      ),
      LyricLine(100.6, 'And I ask you to stay', 'Và tôi lại xin em ở lại'),
    ],
  ),
  Song(
    title: 'Saboteurs',
    ...
    lyrics: [
      ...
      LyricLine(44.8, 'The daylight came and went', 'Ánh ngày đến rồi lại đi'),
      LyricLine(
        48.4,
      ...
      LyricLine(135.3, 'Burn who I’ve been', 'Thiêu rụi con người tôi từng là'),
      LyricLine(
        137.6,
        'Wipe the slate, a clean escape, the end',
        'Xoá sạch mọi thứ, một lần trốn thoát trong sạch, đến hồi kết',
      ),
      LyricLine(155.2, 'Run like the wind', 'Chạy như gió cuốn'),
      LyricLine(
        156.2,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(71, 'She dreams in blue', 'Nàng mơ trong sắc xanh'),
      LyricLine(
        81.7,
        'Wait for it, it\'s all she ever knew',
        'Hãy chờ đợi, đó là tất cả những gì nàng từng biết',
      ...
      LyricLine(159, 'She dreams in blue', 'Nàng mơ trong sắc xanh'),
      LyricLine(
        169.2,
        'Wait for it, it\'s all she ever knew',
        'Hãy chờ đợi, đó là tất cả những gì nàng từng biết',
      ...
      LyricLine(281.4, 'She dreams in blue', 'Nàng mơ trong sắc xanh'),
      LyricLine(
        284.5,
        'Wait for it, it\'s all she ever knew',
        'Hãy chờ đợi, đó là tất cả những gì nàng từng biết',
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(64.8, 'And I wait, yeah I wait', 'Và tôi chờ, vâng tôi chờ'),
      LyricLine(75.8, 'Hey hey, I\'m ok', 'Này này, tôi ổn mà'),
      LyricLine(
        85.1,
        'I don\'t need this anyway, I\'m fine',
        'Dù sao tôi cũng không cần điều này, tôi ổn',
      ),
      LyricLine(85.3, 'What\'s yours and mine', 'Cái gì là của em và của tôi'),
      LyricLine(85.5, 'Oh oh, I don\'t know', 'Ồ, tôi chẳng biết'),
      LyricLine(
        87.9,
      ...
      LyricLine(156.1, 'And I wait, yeah I wait', 'Và tôi chờ, vâng tôi chờ'),
      LyricLine(159.6, 'Hey hey, I\'m ok', 'Này này, tôi ổn mà'),
      LyricLine(
        163.2,
        'I don\'t need this anyway, I\'m fine',
        'Dù sao tôi cũng không cần điều này, tôi ổn',
      ),
      LyricLine(163.9, 'What\'s yours and mine', 'Cái gì là của em và của tôi'),
      LyricLine(164.6, 'Oh oh, I don\'t know', 'Ồ, tôi chẳng biết'),
      LyricLine(
        169.2,
        'What I was ever hoping I would find',
        'Điều tôi từng hy vọng mình sẽ tìm thấy là gì',
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(54.2, 'The coda never drops', 'Đoạn kết chẳng bao giờ đến'),
      LyricLine(
        59.1,
      ...
      LyricLine(
        105.7,
        'The blemishes compound',
        'Những vết xước cứ chồng chất',
      ),
      LyricLine(112.6, 'And chip away the sound', 'Và bào mòn dần âm thanh'),
      LyricLine(
        117.9,
  ...
  Song(
    ...
    lyrics: [
      ...
      LyricLine(55.5, 'But time is advancing', 'Nhưng thời gian cứ thế trôi'),
      LyricLine(58.2, 'A drip, then a flood', 'Một giọt, rồi thành cơn lũ'),
      LyricLine(
        61,
