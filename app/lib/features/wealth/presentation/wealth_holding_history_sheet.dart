...
/// (khac Crypto co CryptoCoinDetailScreen rieng voi chart that qua OKX
/// candles) vi cac nguon gia con lai (Twelve Data/VCB) khong co san chuoi gia
/// LICH SU, chi co gia HIEN TAI - hien thi gia tri+PNL hien tai va toan bo
/// lich su mua/ban/danh gia lai (loc theo symbol trong asset_type).
///
/// Hien INLINE ben trong man Portfolio dang mo (KHONG con la
/// showModalBottomSheet rieng chong len) de tranh "pop-up long pop-up" -
/// xem [onBack].
class WealthHoldingHistoryView extends ConsumerWidget {
  const WealthHoldingHistoryView({
    super.key,
