...
class _AddDebtSheetState extends ConsumerState<_AddDebtSheet> {
  ...
  Widget build(BuildContext context) {
    // Scaffold(resizeToAvoidBottomInset: true) thay vi Padding(bottom:
    // viewInsets.bottom) thu cong - man co nhieu TextField dong thoi
    // (nhieu dong nguoi trong che do chia) tung bi bao cao khong bam duoc
